    ...
    (function(n) {
      ...
      a.a = function() {
        ...
        return {
          ...
          o: function(a, b) {
            if ("function" == typeof Array.prototype.indexOf) return Array
              .prototype.indexOf.call(a, b);
          ...
          Ba: function(a, b) {
            if (a.length) {
              ...
              for (; 1 < a.length && a[a.length - 1].parentNode !==
                b;) a.length--;
              if (1 < a.length) {
                var c =
                  a[0],
          ...
          if (d) {
            ...
            for (var A = 0, y; y = d[A]; ++A) {
              ...
              if (44 === v) {
                ...
                v || 91 === v ? ++p : 41 === v || 125 === v || 93 ===
                v ? --p : r || h.length || 34 !== v && 39 !== v || (y =
                  y.slice(1, -1));
              h.push(y)
            }
          }
